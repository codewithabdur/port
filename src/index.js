    ...
    <><>
        ...
        <div className="container flex items-center justify-between">
          ...
          <div className="hidden lg:block">
            <ul className="flex items-center">
              ...
              <link href="https://codewithabdur.github.io/Form/" target="_blank"><span
                  className="cursor-pointer pt-0.5 font-header font-semibold uppercase text-white">Contact</span>

                <span className="block h-0.5 w-full bg-transparent group-hover:bg-yellow"></span></link>
              </li>
            ...
            <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
              ...
              <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                ...
                <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                  <link href="https://www.facebook.com/profile.php?id=100064823755797" target="_blank" className="pl-4">
                    <i className="bx bxl-facebook-square text-2xl text-white hover:text-yellow"></i>
                  </link>
                  <link href="https://twitter.com/CodeWithAbdur" target="_blank" className="pl-4">
                    <i className="bx bxl-twitter text-2xl text-white hover:text-yellow"></i>
                  </link>
                  <link href="https://www.youtube.com/c/lucygamer01" target="_blank" className="pl-4">
                    <i className="bx bxl-youtube text-2xl text-white hover:text-yellow"></i>
                  </link>
                  <link href="https://www.linkedin.com/in/ark-gamerz-857150244/" target="_blank" className="pl-4">
                    <i className="bx bxl-linkedin text-2xl text-white hover:text-yellow"></i>
                  </link>
                  <link href="https://www.instagram.com/codewithabdur/" target="_blank" className="pl-4">
      ...
      <div className="container py-16 md:py-20" id="portfolio">
        ...
        <div className="mx-auto grid w-full grid-cols-1 gap-8 pt-12 sm:w-3/4 md:gap-10 lg:w-full lg:grid-cols-2">
          ...
          <link href="https://codewithabdur.github.io/CodeWithAbdur_Particle/"  target ="_blank" 
          className="mx-auto transform transition-all hover:scale-105 md:mx-0">
...
{/* =========================================================================================================================        */}
        <form className="mx-auto w-full pt-10 sm:w-3/4">
          ...
          <button
            className="mt-6 flex items-center justify-center rounded bg-primary px-8 py-3 font-header text-lg font-bold uppercase text-white hover:bg-grey-20"><link href="https://codewithabdur.github.io/Form/" target="_blank">Send</link>
            <link href='https://codewithabdur.github.io/Form/'></link>
        ...
        <div className="container relative z-30">
          ...
          <form className="mt-6 flex flex-col justify-center sm:flex-row">
            ...
            <button
              ...
              <link href="https://rzp.io/l/AmHxSSwy" target="_blank">JOIN ME</link>
            </button>
          </form>
        </div>
      </div>
          ...
          <div className="container flex flex-col justify-between py-6 sm:flex-row">
            ...
            <div className="flex items-center justify-center pt-5 sm:justify-start sm:pt-0">
              <link href="https://www.facebook.com/profile.php?id=100064823755797" target="_blank">
                <i className="bx bxl-facebook-square text-2xl text-white hover:text-yellow"></i>
              </link>
              <link href="https://twitter.com/CodeWithAbdur" target="_blank" className="pl-4">
                <i className="bx bxl-twitter text-2xl text-white hover:text-yellow"></i>
